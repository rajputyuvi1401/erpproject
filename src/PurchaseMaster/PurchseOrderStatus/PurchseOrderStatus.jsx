                ...
                <div className="PurchaseOrderstatus-header">
                  <div className="row flex-nowrap align-items-center">
                    <div className="col-md-4">
                      <h5 className="header-title text-start">Pending MRN Release List</h5>
                    </div>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>
                              ...
                              <label htmlFor="poNo" className="ml-2">PO No</label>
                            </th>
                            <th>
                              <input type="checkbox" id="itemGroup" />
                              <label htmlFor="itemGroup" className="ml-2">Item Group POWise</label>
                            </th>
                            <th>
                              <input type="checkbox" id="supportETA" />
                              <label htmlFor="supportETA" className="ml-2">Support By ETA Days</label>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              ...
                              <label htmlFor="snowBalQty" className="form-control">Snow Bal Qty Only</label>
                            </td>
                            <td><button className="pobtn">Search</button></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
