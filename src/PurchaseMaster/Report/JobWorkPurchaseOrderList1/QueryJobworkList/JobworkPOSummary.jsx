...
const JobworkPOSummary = () => {
  ...
  const [activeTab, setActiveTab] = useState("query");
   ...
   const navigate = useNavigate();
      ...
      const handleClose = () => {
        navigate("/jobwork-purchase-order-list");
      };
        ...
        <div className="top-but3-header mb-4 text-start">
               <div className="row align-items-center">
                    <div className="col-md-4">
                      <h5 className="header-title">Jobwork PO Summary</h5>
                    </div>
                    <div className="col-md-8 text-end">
                       <div className="d-flex align-items-center justify-content-end">                          
                          <Link className="vndrbtn me-2" to={"/JobworkQuery"}>
                             Query Master
                          </Link>
                ...
                <div className="tab-panel">
                   <div className="mb-3">
                     ...
                     <div className="row">
                      ...
                      <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="custName" className="form-label"> PO No:</label>
                        </div>
                        <div className="col-md-3">
                      ...
                      <div className="row mt-2">
                       ...
                       <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="status" className="form-label"> Query Name:</label>
                        </div>
                        <div className="col-md-3">
                          <select className="form-select" id="status">
                            <option value="">All</option>
