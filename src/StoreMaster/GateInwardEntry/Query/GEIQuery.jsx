        ...
        <div className="top-but3-header mb-4 text-start">
               <div className="row align-items-center">
                    <div className="col-md-4">
                      <h5 className="header-title">Gate Entry Inward Query</h5>
                    </div>
                    <div className="col-md-8 text-end">
                       <div className="d-flex align-items-center justify-content-end">                          
                          <Link className="vndrbtn me-2" to={"/QueryGate"}>
                              Query Master
                          </Link>
                   ...
                   <div className="mb-3">
                      ...
                      <div className="row">
                        <div className="col-md-2">
                          <label htmlFor="customerType" className="form-label"> Query </label>
                        </div>
                      </div>
                      ...
                      <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label">  Type :</label>
                        </div>
                        <div className="col-md-3">
                        <select className="form-select" id="status">
                      ...
                      <div className="row mt-2">
                        ...
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label"> Gate Entry No :</label>
                        </div>
                        <div className="col-md-3">
