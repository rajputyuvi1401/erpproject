...
const InwardChallanQuery = () => {

  const [activeTab, setActiveTab] = useState("query");
   const navigate = useNavigate();
    
      const handleClose = () => {
        navigate("/Inward-challan-list");
      };
        ...
        <div className="top-but3-header mb-4 text-start">
               <div className="row align-items-center">
                    <div className="col-md-4">
                      <h5 className="header-title"> 57F4 Inward Challan Query</h5>
                    </div>
                    <div className="col-md-8 text-end">
                       <div className="d-flex align-items-center justify-content-end">                          
                          <Link className="vndrbtn me-2" to={"/QueryInward"}>
                              Query Master
                          </Link>
                ...
                <div className="tab-panel">
                   <div className="mb-3">
                      ...
                      <div className="row mt-2">
                       ...
                       <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label">  Series :</label>
                        </div>
                        <div className="col-md-3">
                        <select className="form-select" id="status">
                      ...
                      <div className="row mt-2">
                        ...
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label"> Invard No :</label>
                        </div>
                        <div className="col-md-3">
                      ...
                      <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label">  Supp. Name :</label>
                        </div>
                        <div className="col-md-3">
                      ...
                      <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label">  Vender Challan No :</label>
                        </div>
                        <div className="col-md-3">
                        <input type="text" className="form-control" placeholder="Name..." />
                        </div>
...
export default InwardChallanQuery