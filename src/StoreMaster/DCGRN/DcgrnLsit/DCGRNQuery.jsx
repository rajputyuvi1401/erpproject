        ...
        <div className="top-but3-header mb-4 text-start">
               <div className="row align-items-center">
                    <div className="col-md-4">
                      <h5 className="header-title"> DCGRN Query</h5>
                    </div>
                    <div className="col-md-8 text-end">
                       <div className="d-flex align-items-center justify-content-end">                          
                          <Link className="vndrbtn me-2" to={"/QueryDCgrn"}>
                              Query Master
                          </Link>
              ...
              {activeTab === "query" && (
                <div className="tab-panel">
                   <div className="mb-3">
                      ...
                      <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="cityName" className="form-label">  GRN :</label>
                        </div>
                        <div className="col-md-3">
                         <select className="form-select" id="status">
                            <option value="">DC GRN</option>
                            <option value="active"></option>
                          </select>
                        </div>
                      ...
                      <div className="row mt-2">
                        <div className="col-md-2">
                          <label htmlFor="status" className="form-label">DC GRN No:</label>
                        </div>
                        <div className="col-md-3">
