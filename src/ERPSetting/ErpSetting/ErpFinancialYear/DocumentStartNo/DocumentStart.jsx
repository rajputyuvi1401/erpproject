                  ...
                  <div className="Document-header mb-4 text-start">
                    <div className="row align-items-center">
                      <div className="col-md-4">
                        <h5 className="header-title">Document Start No.(18 - 19)</h5>
                      </div>
                    </div>
                  </div>
...
<label>Enq. Booking register / Purchase Enq No / RFQ
FG To FG Movement / RM Stock Transaction
Shop Floor To Store Transfer / Warehouse to Warehouse Transfer
Purchase QC / 57F4 QC / Inprocess QC / Sales return QC
Dispatch TC / PDI / MPI / FPI / Setup Approval
Hot Inspection / CAPA / Line Inspection
Machine Plan / Process Control Chart / 4M
Line rejection / Fg rejection /Reject to ok
Machine Installation</label>
                                </div>
...
<input className="form-control" type="text"/>
                             ...
                             <div className="row">
                                <div className="col-md-4">
                                <label>Jobwork Invoice / CCI / DC+JW Invoice:</label>
                                </div>
                                <div className="col-md-8">
                                    <input className="form-control" type="text"/>
                                </div>
...
<input className="form-control" type="text"/>
                    ...
                    <div className="row text-start">
                                ...
                                <div className="col-md-8">
                                   <button type="button" className="btn">Set To All</button>
                                   <button type="button" className="btn">Update All</button>
                                </div>
                             </div>
                  </div>
