            ...
            <div className="Main-NavBar">
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="EmailsetUp">
                  ...
                  <div className="EmailsetUp-header mb-2 text-start">
                    <div className="row align-items-center">
                      ...
                      <div className="col-md-6 text-end">
                        ...
                        <button type="button" className="vndrbtn" onClick={() => setIsDefaultSettingsOpen(true)}>
                          Default Setting
                        </button>

                        <DefaultSettingsModal isOpen={isDefaultSettingsOpen} onClose={() => setIsDefaultSettingsOpen(false)} />
                        ...
                        <div className="EmailsetUpmain">
                          <form onSubmit={handleSubmit} className="email-form">
                            ...
                            <div className="button-group">
                              <button type="submit" className="vndrbtn btn-primary">Save</button>
                              <button type="button" className="vndrbtn btn-secondary" onClick={handleClear}>Clear</button>
                            </div>
                          </form>
                        </div>
                      </div>
                              ...
                              <tbody>
                                {emailConfigs.map((config, index) => (
                                  <tr key={config.id}>
                                    ...
                                    <td>
                                      <button className="vndrbtn btn-link">  <FiEdit />  </button>
                                      <button className="vndrbtn btn-link text-danger"> <MdDeleteForever /> </button>
                                    </td>
                                  </tr>
                                ))}
                              </tbody>
