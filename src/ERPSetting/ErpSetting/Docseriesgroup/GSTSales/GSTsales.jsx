            ...
            <div className="Main-NavBar">
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="DataSeries">
                  ...
                  <div className="GSTsalestable mt-2">
                    <div className="row">
                        <div className="col-md-6">
                            <h4 className="header-title text-primary text-start">#GST Invoice</h4>
                        <div className="table-responsive mt-2">
                            <table className="table table-bordered table-striped">
                              <thead>
                                <tr>
                                  <th scope="col">Series_No</th>
                                  <th scope="col">Series Name</th>
                                  <th scope="col">Type</th>
                                  <th scope="col">Prefix</th>
                                  <th scope="col">Suffix</th>
                                  <th scope="col">Rpt</th>
                                  <th scope="col">Max Item Limit</th>
                        ...
                        <div className="col-md-6">
                        <h4 className="header-title text-primary text-start">#Jobwork Invoice</h4>
                        <div className="table-responsive mt-2">
                            <table className="table table-bordered table-striped">
                              <thead>
                                <tr>
