            ...
            <div className="Main-NavBar">
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="Quotation">
                   ...
                   {/* Header */}
                                  <div className="Quotation-header mb-2 text-start">
                  ...
                  <div className="Quotationtable mt-2">
                    <div className="row">
                        <div className="col-md-6">
                            <h4 className="header-title text-primary text-start">Customer Type Master</h4>
                        ...
                        <div className="col-md-6">
                        <h4 className=" header-title text-primary text-start">Item Master</h4>
                        <div className="table-responsive mt-2">
                            <table className="table table-bordered table-striped">
                              <thead>
                                <tr>
