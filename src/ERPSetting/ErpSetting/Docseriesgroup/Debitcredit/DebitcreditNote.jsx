...
const DebitcreditNote = () => {
  ...
  return (
    <div className="DebitcreditNotes">
            ...
            <div className="Main-NavBar">
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="DebitcreditNotes">
                   ...
                   {/* Header */}
                                  <div className="DebitcreditNotes-header mb-2 text-start">
                                  ...
                                  {/* Button Group */}
                                  <div className="DebitcreditNotesmain">
                  ...
                  <div className="DebitcreditNotestable mt-2">
                    <div className="row">

                        <div className="col-md-6">
                            <h4 className="header-title text-primary text-start">Debit Note</h4>
                        ...
                        <div className="col-md-6">
                        <h4 className="header-title text-primary text-start">Credit Note</h4>
                         <div className="table-responsive mt-2">
                            <table className="table table-bordered table-striped">
                              <thead>
                                <tr>
