          ...
          <div className="col-md-12">
            <div className="Main-NavBar">
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="WeeklyOff">
                  <div className="WeeklyOff-header mb-2 text-start">
                    <div className="row align-items-center">
                      <div className="col-md-4">
                        <h5 className="header-title">Weekly Off / Holiday Setting</h5>
                      </div>
                      <div className="col-md-8 text-end">
                         <Link type="button" className="vndrbtn" to='/WeekMaster'>Week Master</Link>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="WeeklyOff-form">
                    <div className="row g-3">
                      <div className="col-md-2 col-sm-12">
                        ...
                        <button className="vndrbtn btn-primary mt-2">Update Weekly Off</button>
                      </div>

                      <div className="col-md-10 col-sm-12">
                        <h6 className="header-title">Holiday Setting:</h6>
                        
                        <div className="WeeklyOffmain mt-3">
                            <div className="row g-2">
                              ...
                              <div className="col-md-2" style={{marginTop:'28px'}}>
                                <button className="vndrbtn" onClick={addHoliday}>
                                  Add Holiday
                                </button>
                              </div>
                            </div>
                        ...
                        <div className="WeeklyOfftable mt-4">
