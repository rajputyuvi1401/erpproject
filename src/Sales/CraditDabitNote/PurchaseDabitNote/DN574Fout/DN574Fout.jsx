          ...
          <div className="col-md-12">
            <div className="Main-NavBar">
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="DN574Fout">
                  <div className="DN574Fout-header mb-2 text-start">
                  ...
                  <div className="DN574Fout-main">
                    <div className="row text-start">
                      ...
                      <div className="col-2"><button className="vndrbtn ">Select</button>
                      </div>
                    </div>
                  </div>

                  <div className="DN574Fout-main mt-2">
