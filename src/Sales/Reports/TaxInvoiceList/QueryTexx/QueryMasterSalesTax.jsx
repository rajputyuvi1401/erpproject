                ...
                <div className="top-but3-header mb-4 text-start">
                    <div className="row align-items-center">
                        <div className="col-md-4">
                            <h5 className="header-title">Sales Tax Query Master</h5>
                        </div>
                        <div className="col-md-8 text-end">
                           <Link className="vndrbtn" to="/ColumnSetup"> Column Setup </Link>
...
export default QueryMasterSalesTax