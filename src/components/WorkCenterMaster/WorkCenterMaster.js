              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                  ...
                  <div className="container-fluid">
                    <div className="row text-start centerselect">
                      ...
                      <div className="col-md-2 col-sm-3 mb-3 mb-sm-0">
                        <label htmlFor="machineType" className="col-form-label">
                          Machine Type
                        </label>
                      </div>
                      <div className="col-md-3 col-sm-9 mb-3 mb-sm-0">
                ...
                <div className="workTable">
                  <div className="container-fluid">
                        ...
                        <tbody>
                          {records.map((record, index) => (
                            <tr key={record.id}>
                              ...
                              <td>{record.active}</td>
                              <td>
                                <button className="btn-tableww">Edit</button>
                              </td>
                              <td>
                                <button className="btn-tableww">Delete</button>
                              </td>
                              <td>
                                <button className="btn-tableww">Doc</button>
                              </td>
                            </tr>
                          ))}
                        </tbody>
                    ...
                    <div className="record-count text-start">
