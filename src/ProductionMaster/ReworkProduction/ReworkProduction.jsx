...
import { fetchShifts,fetchContractors, fetchOperators,fetchUnitMachines,
  fetchSupervisors,  postProductionEntry} from "../../Service/Production.jsx";
...
/>
                        ...
                        <div className="col-md-3">
                          ...
                          <input type="date" name="ReworkDate" value={formData.ReworkDate} onChange={handleChange} className="form-control" />
                        
                        <input type="time" name="Reworktime" value={formData.Reworktime} onChange={handleChange} className="form-control" />
                          </div>
                      ...
                      <div className="row mt-3 text-start">
                        ...
                        <div className="col-md-3">
                          ...
                          <input type="text" name="ItemCode" className="form-control" value={formData.ItemCode} onChange={handleChange} />
                        </div>
                        <div className="col-md-3">
                          <label>Part Code:</label>
                          <input type="text" name="PartCode" className="form-control" value={formData.PartCode} onChange={handleChange} />
                        </div>
                        ...
                        <div className="col-md-3">
                          <label>Heat No:</label>
                          <select className="form-control" name="HeatNo" value={formData.HeatNo} onChange={handleChange}>
                        ...
                        <div className="col-md-3">
                          ...
                          <input type="time" name="ProdTime" className="form-control" value={formData.ProdTime} onChange={handleChange} />
                        </div>
                        <div className="col-md-3">
                          <label>Rework To Ok:</label>
                          <input type="text" name="ReworktoOk" className="form-control" value={formData.ReworktoOk} onChange={handleChange} />
                        </div>
                      </div>
                ...
                <div className="col-md-1">
                  ...
                  <input type="text" name="idle_reason" className="form-control" value={idleTime.idle_reason} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-1">
                  <label>From Time</label>
                  <input type="time" name="from_time" className="form-control" value={idleTime.from_time} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-1">
                  <label>To Time</label>
                  <input type="time" name="to_time" className="form-control" value={idleTime.to_time} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-1">
                  <label>Total</label>
                  <input type="time" name="total_time" className="form-control" value={idleTime.total_time} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-2">
                  <label>Supervisor/Operator</label>
                  <input type="text" name="supervisor_operator" className="form-control" value={idleTime.supervisor_operator} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-2">
                  <label>Setting Part</label>
                  <input type="text" name="setting_part" className="form-control" value={idleTime.setting_part} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-2">
                  <label>Remark</label>
                  <input type="text" name="remark" className="form-control" value={idleTime.remark} onChange={handleIdleTimeChange} />
                </div>
                <div className="col-md-2 d-flex align-items-end">
                  <button type="button" className="btn btn-primary" onClick={addIdleTimeRow}>Add</button>
                </div>
              </div>
                    ...
                    <div className="table-responsive">
                      ...
                      {idleTimeRows.map((row, index) => (
                        <tr key={index}>
                          ...
                          <td>{row.remark}</td>
                          <td>
                            <button className="btn btn-danger btn-sm" onClick={() => deleteIdleTimeRow(index)}>Delete</button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                    ...
                    <div className="table-responsive">
                      <table className="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                          <td>
                              <input type="time" className="form-control" name="ProductionHours" value={formData.ProductionHours} onChange={handleChange}  />
                            </td>
                            <td>
                              <input type="time" className="form-control" name="MachineIdleTime_Detail_Enter" value={formData.MachineIdleTime_Detail_Enter} onChange={handleChange} />
                            </td>
                            <td>
                              <input type="time" className="form-control" name="ActualHours" value={formData.ActualHours} onChange={handleChange} />
                            </td>
                            <td>
                            <div className="d-flex">
                              <input type="time" className="form-control" name="shift_from" value={formData.shift_from} onChange={handleChange} placeholder="From" />
                              <input type="time" className="form-control" name="shift_till" value={formData.shift_till} onChange={handleChange} placeholder="Till" />
                            </div></td>
                            <td>
                            <div className="d-flex">
                            <input type="time" className="form-control" name="break_from" value={formData.break_from} onChange={handleChange} placeholder="From" />
                            <input type="time" className="form-control" name="break_till" value={formData.break_till} onChange={handleChange} placeholder="Till" />
                           </div> </td>
                            <td>
                              <input type="time" className="form-control" name="total" value={formData.total} onChange={handleChange} placeholder="Total" />
                            </td>
                            <td>
                            <div className="d-flex">
                              <input type="time" className="form-control" name="op_time" value={formData.op_time} onChange={handleChange} placeholder="00:00" />
                              <input type="time" className="form-control" name="lu_time" value={formData.lu_time} onChange={handleChange} placeholder="00:00" />
                              <input type="time" className="form-control" name="mo_time" value={formData.mo_time} onChange={handleChange} placeholder="00:00" />
                              <input type="time" className="form-control" name="total_time" value={formData.total_time} onChange={handleChange} placeholder="00:00" />
</div>
                            </td>
                            <td>
                            <div className="d-flex">
                              <input type="text" className="form-control" name="target_qty" value={formData.target_qty} onChange={handleChange} placeholder="Operator Name" />
                              <input type="text" className="form-control" name="target_qty_hours" value={formData.target_qty_hours} onChange={handleChange} placeholder="Operator Name" />
                           </div> </td>
                            <td>
                              <input type="text" className="form-control" name="ReasonForRework" value={formData.ReasonForRework} onChange={handleChange} placeholder="Setting Part" />
                            </td>
