                ...
                <div className="top-but3-header mb-4 text-start">
                    <div className="row align-items-center">
                        <div className="col-md-4">
                            <h5 className="header-title">Scrap Rejection Query</h5>
                        </div>
                        <div className="col-md-8 text-end">
                            <div className="d-flex align-items-center justify-content-end">
                                <Link type="button" className="vndrbtn me-2" to={"/QueryMasterScrap"}>
                                    Query Master
                                </Link>
                        ...
                        {activeTab === "query" && (
                            <div className="tab-panel">
                                <div className="mb-3 text-start">
                                    ...
                                    <div className="row mt-2">
                                        <div className="col-md-2">
                                            <label htmlFor="from" className="form-label">Scrap No:</label>
                                        </div>
                                        <div className="col-md-3">
                                            <input type="date" className="form-control" />
                                        </div>
                                     ...
                                     <div className="row mt-2">
                                        <div className="col-md-2">
                                            <label htmlFor="todate" className="form-label">Suplier Name :</label>
                                        </div>
                                        <div className="col-md-3">
                                    ...
                                    <div className="row mt-2">
                                        ...
                                        <div className="col-md-3">
                                         ...
                                         <div className="col-md-2">
                                            <label htmlFor="from" className="form-label">Sub Group:</label>
                                        </div>
                                        <div className="col-md-3">
                                            <select className="form-select" name="" id="">
                                                <option value=""> All </option>
                                    ...
                                    <div className="row mt-2">
                                        <div className="col-md-2">
                                            <label htmlFor="todate" className="form-label">User Query:</label>
                                        </div>
                                        <div className="col-md-3">
