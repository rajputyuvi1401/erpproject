...
import {
  fetchShifts, fetchContractors,
  fetchUnitMachines, saveContractorProduction
...
const ContractirList = () => {
  ...
  const handleShiftSelect = (shift) => {
    ...
    const [cardVisibleItemWise, setcardVisibleItemWise] = useState(false);
  
    const toggleCardItemwiseRate = () => {
      setcardVisibleItemWise(!cardVisibleItemWise);
    };
              ...
              <main className={`main-content ${sideNavOpen ? "shifted" : ""}`}>
                <div className="ContractorList">
                  <div className="ContractorList-header mb-2 text-start">
                    <div className="row align-items-center">
                      ...
                      <div className="col-md-8 col-12 text-end">
                        <div className="d-flex justify-content-end gap-2 flex-wrap">
                          ...
                          <button type="button" className="vndrbtn"  onClick={toggleCardItemwiseRate} >
                            Itemwise Rate
                          </button>

                          <Link type="button" className="vndrbtn" to={"/Machinewise Rate"}>
                            Machinewise Rate
                          </Link>
                   ...
                   {cardVisibleItemWise && (
                                      <div className="ProductionDeptCard" style={{width:'800px'}}>
                                        <div className="card">
                                          <div className="card-header d-flex justify-content-between">
                                            ...
                                            <button
                                              className="Closebom"
                                              onClick={toggleCardItemwiseRate}
                                            >
                                              X
                                            </button>
                                          </div>
                                          ...
                                          <div className="row mt-2 align-items-center">
                                            <div className="col-md-6 col-12 mb-2 mb-md-0">
                                              <h5 className="header-title">BreackDown Machine Rate</h5>
                                            </div>
                                            </div>
